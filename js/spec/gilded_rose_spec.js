describe("Gilded Rose", function () {
  ...
  it("should have item quality reduced by 2 when sell_in is less than 0", function () {
  ...
  /* 
    Item Category: Conjured     
      - "Conjured" items degrade in Quality twice as fast as normal items
          change in quality = 2X
*/

  it("should have Conjured item quality decrease by 2 when sell_in is greater than 0", function () {
  ...
  it("should have Conjured item quality decrease to 0 when sell_in is greater than 0 and quality is 1", function () {
  ...
  it("should have Conjured item quality decrease by 4 when sell_in is less than 0", function () {
...
*/
  ...
  it("should have Aged Brie item quality increase by 1 when sell_in is greater than 0", function () {
  ...
  it("should have Aged Brie item quality increase by 1 when sell_in is equal to 0", function () {
  ...
  it("should have Aged Brie item quality increase by 1 when sell_in is less than 0", function () {
  ...
  it("should not have Aged Brie item quality increase by 1 when when quality is 50", function () {
  ...
  */
  ...
  it("should have Backstage passes item quality increase by 1 when sell_in is greater than 10", function () {
  ...
  it("should have Backstage passes item quality increase by 3 when sell_in is less than 5 and greater than 0", function () {
  ...
  it("should have Backstage passes item quality increase to 50 when quality is 49 sell_in is less than 10 but greater than 5", function () {
  ...
  it("should not have Backstage passes item quality increase when quality is 50 sell_in is less than 10 but greater than 5", function () {
  ...
  it("should have Backstage passes item quality increase to 50 when quality is 48 sell_in is less than 5", function () {
  ...
  it("should not have Backstage passes item quality increase when quality is 50 sell_in is less than 5", function () {
  ...
  it("should have Backstage passes quality not less than 0", function () {
    items = [new Item("foo", 10, 0)];
    update_quality();
    expect(items[0].quality).toEqual(0);
    expect(items[0].sell_in).toEqual(9);
